										...
										<form action="<%=request.getContextPath()%>/tablePointServlet">
											...
											<div class="datatable-selection">
												<div class="">
													...
													<select
														...
														<option></option>
														<option name="search-lop" <c:if test="${nameLop == '10A1'}">selected</c:if>>10A1</option>
														<option name="search-lop" <c:if test="${nameLop == '10A2'}">selected</c:if>>10A2</option>
														<option name="search-lop" <c:if test="${nameLop == '10A3'}">selected</c:if>>10A3</option>
				 										<option name="search-lop" <c:if test="${nameLop == '10A4'}">selected</c:if>>10A4</option>
														<option name="search-lop" <c:if test="${nameLop == '11A1'}">selected</c:if>>11A1</option>
														<option name="search-lop" <c:if test="${nameLop == '11A2'}">selected</c:if>>11A2</option>
														<option name="search-lop" <c:if test="${nameLop == '11A3'}">selected</c:if>>11A3</option>
														<option name="search-lop" <c:if test="${nameLop == '12A1'}">selected</c:if>>12A1</option>
														<option name="search-lop" <c:if test="${nameLop == '12A2'}">selected</c:if>>12A2</option>
											...
											<div class="search-point">
												...
												<a href="./insertPoint.jsp"><button type="button"
													class="btn btn-primary search-point-btn">Nhập điểm</button></a>
											</div>
										</form>
